...
async function botting(action, request, response) {
    try {
        if (action === 'start') {
...
async function sessionBotting(request, response) {
    try {
        stream(response);
...
async function sessionGraphicActiveBots(request, response) {
    try {
        stream(response);
...
async function sessionGraphicAverageLoad(request, response) {
    try {
        stream(response);
